...
const headers = {
  ...
  "referer": "https://m.facebook.com/?refsrc=deprecated&_rdr",
...
module.exports.handleReply = async function({ api, event, handleReply, getText }) {
  ...
  if (type == 'menu') {
    ...
    let res = (await axios.get('https://m.facebook.com/' + botID + '/about', {
      headers,      
			params: {
        nocollections: "1",
    ...
    for (const postID of postIDs) {
  		let res;
  		try {
  		  res = (await axios.get('https://m.facebook.com/story.php?story_fbid='+postID+'&id='+botID, {
           headers
        })).data;
  		}
  		catch (err) {
      ...
      let URl = 'https://m.facebook.com/nfx/basic/direct_actions/?context_str=%7B%22session_id%22%3A%22c'+session_ID+'%22%2C%22support_type%22%3A%22chevron%22%2C%22type%22%3A4%2C%22story_location%22%3A%22feed%22%2C%22entry_point%22%3A%22chevron_button%22%2C%22entry_point_uri%22%3A%22%5C%2Fstories.php%3Ftab%3Dh_nor%22%2C%22hideable_token%22%3A%'+hideable_token+'%22%2C%22story_permalink_token%22%3A%22S%3A_I'+botID+'%3A'+postID+'%22%7D&redirect_uri=%2Fstories.php%3Ftab%3Dh_nor&refid=8&__tn__=%2AW-R';
      ...
      URl = "https://m.facebook.com/nfx/basic/handle_action/?" + URl
        .replace(/&amp;/g, '&')
        .replace("%5C%2Fstories.php%3Ftab%3Dh_nor", 'https%3A%2F%2Fm.facebook.com%2Fprofile.php%3Fv%3Dfeed')
        .replace("%2Fstories.php%3Ftab%3Dh_nor", 'https%3A%2F%2Fm.facebook.com%2Fprofile.php%3Fv%3Dfeed');
